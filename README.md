...
|
|-- ThreatCatalogue/
|   +-- ICSThreatCatalogue.xlsx        # Main threat catalogue (output of the SLR)
|
|-- SLR/
...
The file `ThreatCatalogue/ICSThreatCatalogue.xlsx` is the main output of the SLR. It organises security threats by asset type and by protocol, and is used as input by the threat modelling and analytics scripts.
...
Use against production or operational systems is prohibited. Users are solely responsible for ensuring proper authorization and legal compliance.
